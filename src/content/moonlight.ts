...
export const PLAN_BLUEPRINT = [
  {
    ...
    title: '프리미엄 대화 멤버십',
    price: '월 49,000원',
    badge: '코인 + 매일 무료 혜택을 한 번에',
    summary: '매월 90코인에 더해 매일 대화 5건·궁합 월 3회·가족 사주 5명까지, 생활 가까운 질문을 넉넉하게 이어가는 30일 멤버십입니다.',
    features: ['매월 90코인 지급', '매일 대화 5건 무료', '궁합 월 3회 무료', '가족 사주 5명 등록'],
    fit: '사주·궁합·대화를 자주 쓰며 가족까지 함께 보고 싶은 분',
    opens: ['매월 90코인으로 모든 풀이·대화에 사용', '매일 대화 5건 무료로 부담 없이 질문', '궁합 월 3회·가족 사주 5명까지 확장'],
  },
  {
...
> = {
  ...
  premium: {
    ...
    price: '월 49,000원',
    nextRange: '첫 결제 후 30일 이용',
    reassurance: '매월 90코인에 매일 대화 5건·궁합 월 3회·가족 사주 5명까지 가장 넓게 이어 쓰는 메인 플랜입니다.',
    opens: ['매월 90코인 지급', '매일 대화 5건 무료 · 궁합 월 3회 무료', '가족 사주 5명 등록'],
