...
export const DALBIT_TEACHERS: readonly DalbitTeacherCard[] = [
  ...
  },
  {
    ...
    serviceTitle: '별자리',
    shortLabel: '오늘 별자리',
    role: '오늘의 별자리 흐름과 분위기를 가볍게 짚어주는 확장 메뉴입니다.',
    question: '오늘 내 별자리 흐름은 어떨까?',
    href: '/star-sign',
    productPosition: '무료 별자리 메시지와 별자리 궁합으로 확장 예정입니다.',
    status: 'active',
  },
  {
    slug: 'palm-meong',
    ...
    serviceTitle: '고민 상담',
    shortLabel: '편하게 대화',
    role: '주제를 가리지 않고 지금 고민을 편하게 나누는 대화 메뉴입니다.',
    question: '지금 이 고민, 어떻게 풀면 좋을까?',
    href: '/dialogue',
    productPosition: '무료 1:1 대화로 시작합니다.',
    status: 'active',
  },
  {
    slug: 'luck-dwaeji',
...
export const PLAN_BLUEPRINT = [
  ...
  },
  {
    ...
    features: ['매일 해석 30회', '궁합 분석 월 3회', '가족 사주 5명', '긴 사주풀이 미리보기 월 10회', '대화 상담 월 120턴'],
    fit: '풀이를 읽은 뒤 계속 질문하며 생활에 붙여 쓰고 싶은 분',
    opens: ['궁합과 가족 사주를 넉넉히 펼쳐보기', '긴 사주풀이 미리보기 월 10회', '대화 상담 월 120턴과 공정사용정책'],
  },
  {
