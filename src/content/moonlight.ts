...
const ALL_HEADER_SHORTCUTS: readonly MoonlightNavItem[] = [
...
export const TASTE_PRODUCTS: readonly MoonlightTasteProduct[] = [
  ...
  },
  {
    ...
    title: '2027 신년운세',
    price: '19,900원',
    question: '2027년에 무엇을 기대하고, 무엇을 조심할까',
    result: '총운과 가족·재물·학업·연애·건강운을 분기·월별로 풀고, 기대할 일과 조심할 일을 짚습니다.',
...
export const PLAN_BLUEPRINT = [
  {
    ...
    title: '프리미엄 대화 멤버십',
    price: '월 49,000원',
    badge: '상세풀이·달력 무제한 · 대화 매일 5건',
    summary: '상세 풀이·운세 달력 무제한, 매일 대화 5건·궁합 월 3회·가족 사주 5명까지, 생활 가까운 질문을 넉넉하게 이어가는 30일 멤버십입니다.',
    features: ['상세 풀이 무제한', '운세 달력 무제한', '매일 대화 5건', '궁합 월 3회', '가족 사주 5명'],
    fit: '사주·궁합·대화를 자주 쓰며 가족까지 함께 보고 싶은 분',
    opens: ['상세 풀이·운세 달력 무제한으로 깊게 읽기', '매일 대화 5건으로 부담 없이 질문', '궁합 월 3회·가족 사주 5명까지 확장'],
  },
  {
...
> = {
  premium: {
    ...
    reassurance: '상세 풀이·운세 달력 무제한, 매일 대화 5건·궁합 월 3회·가족 사주 5명까지 가장 넓게 이어 쓰는 메인 플랜입니다.',
    opens: ['상세 풀이·운세 달력 무제한', '매일 대화 5건 · 궁합 월 3회', '가족 사주 5명 등록'],
    notices: ['첫 결제 후 30일 이용권으로 반영', '언제든 플랜 화면에서 상태 확인 가능', '이용 내역과 환불 안내를 한 번 더 고지'],
  },
  lifetime: {
    title: '보관형 사주 리포트',
    price: '49,000원',
