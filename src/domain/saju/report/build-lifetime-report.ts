...
export const CHAPTER_PATTERN_TEMPLATES: Record<ChapterPattern, string[]> = {
  signal: [
    '새로운 10년의 문이 열리는 분기점',
    '큰 흐름이 갈리는 결, 다음 10년의 방향이 정해지는 시기',
  ...
  fomoAd: [
    '기세가 잘 받쳐주는 결, 흐름에 맞춰 추진하기 좋은 10년',
    '추진력이 모이는 결, 출발선에 서 보기 좋은 시기',
    '드러내기 좋은 결, 평소 준비를 꺼내볼 시기',
  ],
  hope: [
    '추진력이 다시 살아나는 결, 차근차근 출발하기 좋은 시기',
    '받쳐주는 흐름이 들어오는 결, 작은 한 걸음으로 시작',
    '회복과 정리가 끝나고 본격 도약이 시작되는 시기',
  ],
  transform: [
    '현실적인 결과물이 자리잡는 결, 수확 단계로 가는 10년',
    '쌓아둔 기반이 돈으로 바뀌는 결실의 10년',
    '눈에 보이는 성과로 변환되는 시기, 마무리를 챙기세요',
  ],
  warning: [
    '⚠️ 보존이 우선인 결 — 몸과 마음을 챙기는 10년',
  ...
  secret: [
    '흐름이 바뀌는 결, 작은 루틴을 지키는 10년',
    '잘 풀리는 사람들의 공통 루틴, 이 10년의 핵심',
    '생활 결을 잡아주는 4가지 작은 행동',
  ],
};
