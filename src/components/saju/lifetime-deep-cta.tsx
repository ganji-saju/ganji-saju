...
export function LifetimeDeepCta({ slug, initialEntitlement }: Props) {
  ...
  return (
    <TrackedLink
      ...
      className="ml-auto inline-flex items-center justify-center rounded-[12px] bg-[var(--app-pink)] px-5 py-2.5 text-[15px] font-extrabold text-white shadow-[0_12px_28px_rgba(142,42,32,0.32)]"
    >
      결제하기 →
    </TrackedLink>
  );
