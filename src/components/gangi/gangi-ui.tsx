...
export const GANGI_TEACHERS = [
  ...
  { zodiac: 'dragon', name: '사주용선생', topic: '사주 종합', desc: '내 흐름을 생년월일 정보로 봅니다', href: '/saju/new', price: '9,900원' },
  ...
  { zodiac: 'sheep', name: '궁합양선생', topic: '궁합', desc: '상대와의 거리감과 속도를 봅니다', href: '/compatibility/input', price: '9,900원' },
