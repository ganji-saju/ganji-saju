    ...
    <article className="app-panel-muted flex h-full flex-col p-5">
      <div className="flex items-start justify-between gap-3">
        <div>
          ...
          <h3 className="mt-3 text-3xl text-[var(--app-ivory)]">{item.title}</h3>
        </div>
        {item.badge ? (
          <span className="rounded-full border border-[var(--app-gold)]/24 bg-[var(--app-gold)]/10 px-3 py-1 text-sm text-[var(--app-gold-text)]">
            {item.badge}
          </span>
        ) : null}
      </div>

      <p className="mt-3 text-base leading-7 text-[var(--app-copy)]">{item.summary}</p>
      ...
      <div className="mt-5 rounded-[18px] border border-[var(--app-line)] bg-[rgba(255,255,255,0.03)] px-4 py-4">
        ...
        <p className="mt-2 text-base leading-7 text-[var(--app-copy)]">{item.recommendation}</p>
      </div>
      ...
      <div className="mt-4 rounded-[18px] border border-[var(--app-line)] bg-[rgba(255,255,255,0.03)] px-4 py-4">
        ...
        <p className="mt-2 text-base leading-7 text-[var(--app-copy)]">{item.whatToCheck}</p>
      </div>
