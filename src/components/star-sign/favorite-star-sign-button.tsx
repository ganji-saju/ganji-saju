...
export function FavoriteStarSignButton({
  ...
  if (isAnonymous) {
    return (
      <Link
        ...
        className="inline-flex items-center gap-1.5 rounded-full border bg-white px-3.5 py-1.5 text-[11.5px] font-bold text-[var(--app-copy-muted)]"
  ...
  return (
    <button
      ...
      disabled={pending}
      className="inline-flex items-center gap-1.5 rounded-full border px-3.5 py-1.5 text-[11.5px] font-bold transition-transform active:scale-95 disabled:opacity-60"
      style={
        isFavorited
          ? {
