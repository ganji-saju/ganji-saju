...
const CATEGORY_META: Record<TodayScoreItem['key'], CategoryMeta> = {
  ...
  love: {
    ...
    bodyHints: {
      high:
        '마음을 살짝 말해도 잘 닿는 흐름입니다. 연락이 망설여졌다면 한 줄만 먼저 보내보세요. 새 만남 자리에서는 듣는 자세가 매력으로 읽힙니다.',
      mid:
  ...
  relationship: {
    ...
    bodyHints: {
      ...
      low:
        '사소한 말이 크게 들리는 날입니다. 가까운 사람일수록 말 끝을 부드럽게 다듬고, 단정 문구는 잠시 미루세요. 혼자 정리할 시간이 보탬이 됩니다.',
    },
  },
  condition: {
    icon: '🏥',
