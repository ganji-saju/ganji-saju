...
const DIALOGUE_EXPERT_RAG_OVERLAYS: Record<DialogueExpertId, DialogueExpertRagOverlay> = {
  rat: {
    visibleOpening: '성향선생은 성격보다 먼저 반복되는 반응을 봅니다.',
  ...
  ox: {
    visibleOpening: '오늘운세선생은 오늘 안에 바꿀 행동 하나부터 봅니다.',
  ...
  tiger: {
    visibleOpening: '명리선생은 한 번의 사건보다 오래 반복된 흐름을 봅니다.',
  ...
  rabbit: {
    visibleOpening: '타로선생은 정답보다 지금 마음이 걸린 장면을 먼저 봅니다.',
  ...
  dragon: {
    visibleOpening: '사주선생은 질문의 결론과 이유를 함께 봅니다.',
  ...
  snake: {
    visibleOpening: '꿈해몽선생은 꿈이나 반복 생각이 남긴 마음 신호를 봅니다.',
  ...
  horse: {
    visibleOpening: '길일선생은 그 일에 좋은 날과 한 번 더 확인할 날을 나눠 봅니다.',
  ...
  sheep: {
    visibleOpening: '궁합선생은 상대와 나의 속도 차이부터 봅니다.',
  ...
  monkey: {
    visibleOpening: '관상선생은 얼굴 평가가 아니라 사람들에게 전해지는 분위기를 봅니다.',
  ...
  rooster: {
    visibleOpening: '별자리선생은 오늘 별자리 흐름에서 가볍게 챙길 한 가지를 봅니다.',
  ...
  dog: {
    visibleOpening: '대화상담선생은 무엇이든 편하게 꺼내면 지금 마음부터 같이 정리해요.',
  ...
  pig: {
    visibleOpening: '행운선생은 큰 행운보다 지금 잡을 작은 기회를 봅니다.',
