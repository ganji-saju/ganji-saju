...
export const STAR_SIGN_CONTENT: Record<StarSignSlug, SignContent> = {
  aries: {
    ...
    loveCaveat: '익숙해지면 말이 줄어들어 식어 보일 수 있다',
  ...
  cancer: {
    ...
    loveCaveat: '마음 전달이 간접적이라 오해가 쌓이기 쉽다',
  ...
  capricorn: {
    ...
    loveCaveat: '마음 전달이 적어 차갑게 비칠 수 있다',
