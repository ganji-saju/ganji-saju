...
function pickStrengthVariant(level: string | null | undefined, seed: number): string {
  const variants: Record<'신강' | '신약' | '중화', string[]> = {
    신강: [
      ...
      '앞장서서 끌고 가는 힘이 있어 시작은 빠르지만 마무리까지 호흡을 챙기면 좋아요.',
      '추진력이 강한 편이라 속도가 붙을 때 한 번씩 주변을 돌아보면 더 단단해집니다.',
      '내 의지가 또렷해 결정이 빠른 편이라 한 박자 확인을 더 두면 안정적이에요.',
    ],
    신약: [
      '주변 분위기와 컨디션에 영향을 받기 쉬운 편입니다.',
      '주변 흐름과 사람 분위기에 휘청이기 쉬운 편이라 자기 페이스를 먼저 정해두면 편해져요.',
      '주변 신호에 민감해질 수 있어 정보와 일정을 단순화하는 편이 좋아요.',
      '주변 기운에 마음이 잘 움직이는 편이라 내 우선순위를 적어두면 흔들림이 줄어요.',
      '섬세하게 반응하는 편이라 사람과 정보가 많아질 때 한 박자 쉬어가면 좋습니다.',
      '바깥 분위기를 잘 읽는 편이라 그만큼 내 페이스를 먼저 챙기는 게 도움이 됩니다.',
    ],
    중화: [
      '상황을 보고 맞추는 감각이 살아 있는 편입니다.',
      '한쪽으로 치우치지 않아 조율과 중재가 잘 되는 감각이 살아 있어요.',
      '균형을 보며 움직이는 감각이 살아 있어 작은 분기마다 한 박자 쉬어가면 더 정돈됩니다.',
      '강약을 살펴 맞춰가는 편이라 사람 사이에서 중심을 잡아주는 자리에 잘 맞아요.',
      '치우치지 않고 보는 눈이 있어 급할수록 한 박자 쉬어가면 더 또렷해집니다.',
      '양쪽을 두루 살피는 감각이 있어 작은 분기에서 무리 없이 길을 고르는 편이에요.',
    ],
  };
...
const DAILY_LEAD_VARIANTS: Record<DailyRelationKind, string[]> = {
  same: [
    ...
    '오늘은 내 리듬이 또렷해지는 날이라 익숙한 일부터 손에 잡으면 술술 풀립니다.',
    '오늘은 남의 속도에 맞추기보다 내 순서대로 가는 편이 더 잘 맞아요.',
    '오늘은 평소 하던 방식이 그대로 통하는 흐름이라 새 방법을 찾기보다 하던 걸 이어가세요.',
  ],
  support: [
    '오늘은 받쳐주는 흐름이 들어오는 날이라 회복 · 학습 · 정리에 손이 잘 갑니다.',
    '오늘은 도움을 받기 좋은 흐름이라 누군가에게 작게 요청해도 자연스럽습니다.',
    '오늘은 배우거나 채우는 일에 마음이 잘 열리는 날이라 미뤄둔 공부나 정리에 좋아요.',
    '오늘은 주변이 거들어주는 흐름이라 혼자 끌어안던 일을 나눠보면 가벼워집니다.',
    '오늘은 쉬어가며 채우기 좋은 날이라 무리한 확장보다 회복에 시간을 써도 좋습니다.',
  ],
  leak: [
    '오늘은 말이 잘 풀리는 흐름이지만 에너지 소모도 큰 편이라, 하루 종일 쏟지 마세요.',
    '오늘은 의견을 꺼내기 좋은 흐름이라 짧고 명확한 한 줄을 미리 적어두세요.',
    '오늘은 표현이 살아나는 날이라 하고 싶던 말을 꺼내되 핵심만 골라 전하세요.',
    '오늘은 아이디어가 잘 흐르는 흐름이라 떠오른 생각을 메모로 남겨두면 좋아요.',
    '오늘은 말과 활동이 늘어나기 쉬운 날이라 중간중간 숨 고르는 시간을 두세요.',
  ],
  control: [
    '오늘은 누르는 힘이 들어오는 날이라 결정은 한 박자 늦추고 확인 한 번을 더 두세요.',
    '오늘은 무게가 실리는 흐름이라 큰 약속은 다음 날로 미루는 편이 안전합니다.',
    '오늘은 부담이 느껴지기 쉬운 날이라 한 번에 다 하려 말고 작게 쪼개서 가세요.',
    '오늘은 압박감이 올라올 수 있어 중요한 답은 시간을 두고 천천히 정하세요.',
    '오늘은 책임이 무겁게 느껴지는 흐름이라 도움을 청하는 것도 좋은 선택이에요.',
  ],
  spend: [
    '오늘은 정돈해야 하는 흐름이라 작은 실행과 마무리에 손이 많이 갑니다.',
    '오늘은 끝내야 할 일을 먼저 짚고 시작하면 흐름이 가벼워져요.',
    '오늘은 벌여둔 일을 거두기 좋은 날이라 새로 시작하기보다 정리에 무게를 두세요.',
    '오늘은 자잘한 일이 손에 잡히는 흐름이라 미뤄둔 마무리를 하나씩 끝내보세요.',
    '오늘은 비우고 정리할수록 마음이 가벼워지는 날이라 책상부터 한 칸 치워보세요.',
  ],
  neutral: [
    '오늘은 평이한 흐름이라 큰 결단보다 한 일을 끝까지 마무리하는 쪽이 좋습니다.',
    '오늘은 특별히 튀는 신호가 없는 날이라 평소 루틴을 한 번 더 점검해보세요.',
    '오늘은 잔잔하게 흐르는 날이라 무리한 변화보다 하던 일을 이어가면 좋아요.',
    '오늘은 차분한 흐름이라 욕심내기보다 한 가지에 집중하면 더 잘 풀립니다.',
    '오늘은 큰 기복이 적은 날이라 미뤄둔 작은 일을 처리하기에 알맞습니다.',
  ],
};
...
const DAILY_AVOID_VARIANTS: Record<DailyRelationKind, string[]> = {
  same: [
    ...
    '오늘은 내 방식만 고집하다 보면 좋은 제안을 지나칠 수 있어요.',
    '오늘은 속도를 내다 사람을 앞질러 갈 수 있으니 한 번씩 돌아봐 주세요.',
    '오늘은 혼자 다 하려다 지칠 수 있으니 나눌 일은 나눠보세요.',
  ],
  support: [
    '오늘은 도움을 받기 좋은 만큼 의존이 길어지지 않도록 마무리는 직접 정리하세요.',
    '오늘은 결정을 미루기 쉬운 흐름이라 마감은 명확히 잡아두세요.',
    '오늘은 받기만 하다 보면 흐름이 늘어질 수 있으니 작은 마무리는 스스로 지어보세요.',
    '오늘은 편안함에 머물기 쉬운 날이라 해야 할 한 가지는 먼저 처리하세요.',
    '오늘은 기대고 싶어지는 흐름이라 부탁과 책임의 선을 가볍게 정해두면 좋아요.',
  ],
  leak: [
    '오늘은 말이 길어지면 의도와 다르게 들릴 수 있으니 한 줄로 줄여보세요.',
    '오늘은 많이 말하다 보면 에너지가 빠지기 쉽습니다.',
    '오늘은 하고 싶은 말이 많아도 다 꺼내기보다 핵심만 골라 전하세요.',
    '오늘은 활동을 늘리다 지칠 수 있으니 쉬는 시간을 일정에 끼워두세요.',
    '오늘은 즉흥적인 말이 길어지지 않도록 한 호흡 두고 말해보세요.',
  ],
  control: [
    '오늘은 마찰이 생기기 쉬운 흐름이라 즉답보다 한 박자 쉬고 답하세요.',
    '오늘은 큰 결정은 다음 날로 미루는 편이 안전합니다.',
    '오늘은 부담을 혼자 떠안기보다 나눌 수 있는 부분을 찾아보세요.',
    '오늘은 욱하는 순간이 올 수 있으니 한 템포 늦춰 반응하세요.',
    '오늘은 무리해서 끝내려 하기보다 할 수 있는 만큼만 잡아두세요.',
  ],
  spend: [
    '오늘은 작은 결정도 손이 많이 가는 흐름이라 일을 늘리지 않는 편이 좋아요.',
    '오늘은 새로 시작하기보다 마무리에 무게를 두세요.',
    '오늘은 벌이는 일이 많아지지 않도록 우선순위를 먼저 정하세요.',
    '오늘은 자잘한 일에 시간을 다 쓰지 않도록 중요한 한 가지를 먼저 잡으세요.',
    '오늘은 완벽하게 끝내려 애쓰기보다 일단락 짓는 데 무게를 두세요.',
  ],
  neutral: [
    '오늘은 무리한 변화보다 평소 흐름을 유지하는 편이 좋습니다.',
    '오늘은 결정이 흩어지기 쉬우니 우선순위를 한 줄로 적어두세요.',
    '오늘은 큰 욕심을 내기보다 할 수 있는 만큼만 잡으세요.',
    '오늘은 산만해지기 쉬우니 한 번에 한 가지에만 집중하세요.',
    '오늘은 미루던 작은 일을 쌓아두지 않도록 하나씩 처리하세요.',
  ],
};
