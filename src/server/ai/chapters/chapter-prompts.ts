...
export const FEW_SHOT_EXAMPLES: Partial<Record<ChapterId, { input: string; output: string }>> = {
  1: {
    input: `일주: 기사 (기 일간, 토 기운 본질)
격국: 정인격 — 돌봄·후원·배움의 결
강약: 균형이 잡힌 편
지배: 토 기운 / 부족: 금 기운
주된 십성: 정인`,
    output: `\${name}님의 사주는 토 기운을 중심으로 정인의 결이 또렷이 흐릅니다. 가까운 사람을 챙기고 배움을 통해 본인의 깊이를 더하는 패턴이 반복돼요. 다만 책임을 너무 많이 짊어진 다음 갑자기 거리를 두는 패턴이 동시에 따라옵니다. 힘이 빠지기 전에 "지금 도와줄 수 없어요" 한 줄을 미리 적어두면 흐름이 길게 갑니다.`,
  },
  4: {
...
주된 십성: 정인 (배움·자기계발 지출 많음)`,
  ...
  2. 토 기운 강 / 금 기운 부족 — 금 보강이 회복 축
  3. 정인격 역할 반복 — 학습·강의·돌봄 환경에서 빛남
  4. 관계 = 챙기는 자리 — 본인 감정 1주 1회 적기 루틴
  5. 안정 자산형 — 자기계발 비용 별도 칸 분리
  6. 일 = 학습·후원 환경 / 자기 결단 필요 시 부담
  7. 건강 = 토 과함의 둔감 / 가벼운 유산소 + 가을 음식`,
    output: `\${name}님의 평생 흐름을 관통하는 원칙은 세 가지입니다. 첫째, 책임은 미리 글로 적고 시작하세요. 둘째, 금 기운을 의식적으로 채우세요. 셋째, 자기계발과 돌봄 비용을 같은 지갑에서 빼지 마세요. 이 흐름이 잘 작동하는 한 단어 — 결을 적어두는 사람.`,
  },
};
