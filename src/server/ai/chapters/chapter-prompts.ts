...
4. **단정형 금지** — "반드시 ~합니다", "절대 ~하지 마세요", "대흉" 같은 강한 단정 금지. 대신 "~하는 편이 좋습니다", "~신호가 자주 옵니다" 같은 결 말.
...
7. **명리 술어 + 일상어 병기** — 명리 술어 (일주·격국·용신·12운성·신살·십성) 사용 시:
   - 한 단락에 한 번만 + 일상어 풀이 함께 ("정인격(돌봄·후원의 결)").
   - **한 문장에는 명리 술어 최대 1개**. 예: "사주는 X 일주로 정인격의 결이…" → X 일주 + 정인격 = 2개 → ❌. "X 일주의 결이 또렷합니다." 또는 "정인격(돌봄·후원의 결)이 흐릅니다." 둘 중 하나.
   - 카탈로그 나열 금지.
...
주된 십성: 정인`,
  ...
  4: {
    input: `관계 신호: 정인 (돌봄·배움 인연), 부족 십성: 식상 (말 부족)
신살: 원진
상황: 솔로`,
...
- 첫 문장: 일주 *또는* 격국 *중 하나만* 인용 + 핵심 성격 한 줄. (둘 다 인용하면 한 문장 술어 2개 → 룰 7 위반)
  - 예: "기사 일주의 결은 차분히 흐릅니다." OR "정인격(돌봄·후원의 결)이 또렷합니다."
