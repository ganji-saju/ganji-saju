        ...
        <div className="grid gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div className="space-y-7">
            <div className="space-y-4">
              ...
              <div className="space-y-4">
                <h1 className="max-w-3xl text-5xl font-semibold leading-tight tracking-tight text-[#f8f1df] sm:text-6xl lg:text-6xl">
                  오늘의 기분부터
                  <span className="block text-[#d9bc7f]">정통 사주 리포트까지 한 번에 이해되는 시작선</span>
                </h1>
                <p className="max-w-2xl text-lg leading-7 text-white/68 sm:text-xl">
            ...
            <div className="grid gap-3 sm:grid-cols-3">
              <div className="rounded-[26px] border border-white/10 bg-white/[0.04] p-5 sm:col-span-2">
                <div className="text-sm uppercase tracking-[0.22em] text-[#d2b072]/78">{focusMeta.badge}</div>
                <div className="mt-3 text-3xl font-semibold text-[#f7ecd5]">{preview.signal}</div>
                <p className="mt-3 text-base leading-7 text-white/60">{preview.summary}</p>
              </div>

              <div className="rounded-[26px] border border-[#d2b072]/18 bg-[#d2b072]/8 p-5">
                <div className="text-sm uppercase tracking-[0.22em] text-[#d2b072]/82">Preview Score</div>
                <div className="mt-3 text-5xl font-semibold text-[#f7ecd5]">{preview.score}</div>
                <p className="mt-2 text-base leading-6 text-white/62">{preview.action}</p>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
              <Link
                ...
                className={cn(
                  ...
                  'h-12 rounded-full bg-[#d2b072] px-6 text-base font-semibold text-[#111827] hover:bg-[#e0c28a]'
                )}
              >
                  정통 사주 시작
              </Link>
              ...
              <Link
                href="/today-fortune"
                className="inline-flex items-center text-base text-white/62 underline underline-offset-4 transition-colors hover:text-[#f7ecd5]"
              >
                무료운세는 가볍게 둘러보기
              </Link>
            </div>
            ...
            <div className="flex flex-wrap gap-3 pt-1">
              {TRUST_POINTS.map((point) => (
                <span
                  key={point}
                  className="rounded-full border border-white/10 bg-white/5 px-3 py-1.5 text-base text-white/65"
                >
                  {point}
                </span>
              ))}
          ...
          <div className="grid gap-4">
            <article className="rounded-[28px] border border-[#d2b072]/20 bg-[linear-gradient(180deg,rgba(8,16,31,0.92),rgba(20,31,52,0.82))] p-6 shadow-[0_24px_80px_rgba(2,6,23,0.5)]">
              <div className="mb-5 flex items-center justify-between">
                <div>
                  <p className="text-sm uppercase tracking-[0.28em] text-[#d2b072]/75">Main Service</p>
                  <h2 className="mt-2 text-3xl font-semibold text-[#f8f1df]">질문형 사주 리포트</h2>
                </div>
              ...
              <div className="grid gap-4 md:grid-cols-[0.78fr_1fr]">
                <div className="rounded-[24px] border border-white/10 bg-[linear-gradient(180deg,#111c34_0%,#0a1224_100%)] p-5">
                  <div className="text-sm uppercase tracking-[0.2em] text-white/45">{focusMeta.badge}</div>
                  <div className="mt-3 text-4xl font-semibold text-[#f7ecd5]">{focusMeta.label} 리포트</div>
                  <div className="mt-6 space-y-3">
                    <div className="rounded-2xl border border-white/10 bg-white/[0.04] p-3 text-base text-white/60">
                ...
                <div className="flex flex-col justify-between rounded-[24px] border border-white/10 bg-white/[0.04] p-5">
                  <div>
                    <div className="text-base text-white/45">시작 순서</div>
                    <div className="mt-3 grid gap-3">
                      {[
                        ...
                        <div key={step} className="rounded-2xl border border-white/10 bg-white/[0.03] p-3">
                          <div className="text-sm uppercase tracking-[0.18em] text-[#d2b072]/78">
                            Step {index + 1}
                          </div>
                          <p className="mt-2 text-base leading-6 text-white/68">{step}</p>
                        </div>
                      ))}
                    </div>
                  </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="rounded-3xl border border-white/10 bg-white/[0.04] p-5">
                <div className="text-base text-white/45">본 서비스 우선</div>
                <div className="mt-2 text-2xl font-semibold text-[#f7ecd5]">정통사주 → 궁합 → 저장/결제</div>
                <p className="mt-3 text-base leading-6 text-white/58">
                  Day 3 홈은 본 서비스 시작선을 먼저 보여주고, 무료 운세는 뒤쪽 탐색 구간으로 분리합니다.
                </p>
              </div>

              <div className="rounded-3xl border border-[#d2b072]/18 bg-[#d2b072]/8 p-5">
                <div className="text-base text-[#d2b072]/80">무료 유입은 분리</div>
                <div className="mt-2 text-2xl font-semibold text-[#f7ecd5]">SEO 입구는 따로, 서비스 진입은 더 선명하게</div>
