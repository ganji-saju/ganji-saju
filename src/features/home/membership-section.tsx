  ...
  return (
    <section className="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
      <div className="grid gap-5 rounded-[32px] border border-[#d2b072]/18 bg-[linear-gradient(135deg,rgba(210,176,114,0.1),rgba(10,18,36,0.92))] p-7 lg:grid-cols-[1fr_auto] lg:items-center lg:p-9">
        <div>
          <p className="text-base uppercase tracking-[0.24em] text-[#d2b072]/75">Membership</p>
          <h2 className="mt-3 text-4xl font-semibold tracking-tight text-[#f8f1df]">
            단건 리포트를 넘어서 다시 오게 만드는 간지 멤버십
          </h2>
          <div className="mt-5 flex flex-wrap gap-2">
            {MEMBERSHIP_POINTS.map((point) => (
              <span
                key={point}
                className="rounded-full border border-white/10 bg-white/5 px-3 py-1.5 text-base text-white/68"
              >
                {point}
              </span>
            ))}
