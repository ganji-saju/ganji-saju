      ...
      <div className="mx-auto grid max-w-6xl gap-8 px-4 py-16 sm:px-6 lg:grid-cols-[0.92fr_1.08fr] lg:px-8 lg:py-20">
        <div className="space-y-6">
          <div className="space-y-3">
            <p className="text-base uppercase tracking-[0.24em] text-[#d2b072]/75">3-Step Intake</p>
            <h2 className="text-4xl font-semibold tracking-tight text-[#f8f1df]">
              무입력에서 정밀입력까지,
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            {[
              ...
              <div key={step.title} className="rounded-3xl border border-white/10 bg-white/[0.04] p-5">
                <div className="text-base font-medium text-[#f8f1df]">Step {index + 1}</div>
                <div className="mt-2 text-2xl font-semibold text-[#f8f1df]">{step.title}</div>
                <p className="mt-3 text-base leading-6 text-white/55">{step.body}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="rounded-[32px] border border-white/10 bg-[linear-gradient(180deg,rgba(10,18,36,0.96),rgba(7,19,39,0.92))] p-6 shadow-[0_30px_80px_rgba(2,6,23,0.45)] sm:p-7">
          <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <div className="text-sm uppercase tracking-[0.24em] text-white/42">{focusMeta.badge}</div>
              <h3 className="mt-2 text-3xl font-semibold text-[#f8f1df]">{focusMeta.label}에 맞춰 입력 방식 고르기</h3>
            </div>
          ...
          <div className="grid gap-4">
            <div className="rounded-[24px] border border-[#d2b072]/18 bg-[#d2b072]/8 p-5">
              <div className="text-base font-medium text-[#f8f1df]">정통 사주 전용 입력 화면으로 이동</div>
            ...
            <div className="rounded-[24px] border border-white/10 bg-white/[0.04] p-5">
              <div className="text-base font-medium text-[#f8f1df]">입력 검증도 한 곳에서 정리</div>
              <p className="mt-2 text-base leading-7 text-white/60">
            ...
            <div className="rounded-[24px] border border-white/10 bg-white/[0.04] p-5">
              <div className="text-base font-medium text-[#f8f1df]">{focusMeta.label} 중심 리포트를 먼저 미리 보여드립니다</div>
              <p className="mt-2 text-base leading-7 text-white/60">
          ...
          <div className="mt-6 flex flex-col gap-3 sm:flex-row">
            <Link
              ...
              className={cn(
                ...
                'h-12 rounded-full bg-[#d2b072] px-6 text-base font-semibold text-[#111827] hover:bg-[#e3c68d]'
              )}
            >
                3단계 입력 시작하기
            </Link>
