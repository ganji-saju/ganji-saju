...
export const MEGA_NAV: MegaNavGroup[] = [
  ...
  },
  {
    ...
    c1: {
      ...
      // PR #161 — 8명을 coming-soon 으로 분류한 것이 잘못 (실제 동작 영향 없는 메타였음).
      heading: '선생님과 대화',
      items: [
        { label: '엠지쥐선생', desc: '성향 놀이 · MBTI', href: '/guide?teacher=mg-ji', zodiac: 'rat' },
        { label: '오늘소선생', desc: '오늘 루틴 · 생활 조언', href: '/guide?teacher=today-so', zodiac: 'ox' },
        ...
        { label: '꿈뱀선생', desc: '마음 신호 · 꿈해몽', href: '/guide?teacher=dream-baem', zodiac: 'snake' },
        { label: '이동말선생', desc: '이직·이사·여행', href: '/guide?teacher=move-mal', zodiac: 'horse' },
        { label: '궁합양선생', desc: '상대와의 결 · 궁합', href: '/compatibility', zodiac: 'sheep' },
        { label: '관상원선생', desc: '인상과 분위기 · 관상', href: '/guide?teacher=face-won', zodiac: 'monkey' },
        { label: '재물닭선생', desc: '돈 습관 · 재물운', href: '/guide?teacher=wealth-dak', zodiac: 'rooster' },
        { label: '손금멍선생', desc: '손바닥 단서 · 손금', href: '/guide?teacher=palm-meong', zodiac: 'dog' },
        { label: '복돼지선생', desc: '복·쿠폰·리워드', href: '/guide?teacher=luck-dwaeji', zodiac: 'pig' },
      ],
    },
    c2: {
      heading: '상담 유형',
