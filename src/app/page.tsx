...
export const metadata: Metadata = isPaywallLockdown()
  ...
  : {
      // 2026-08-31 — 타로·오늘운세는 당일권 유료(8/25~28 전환). "무료" 카피는 거짓이라 제거.
      title: { absolute: '간지사주 — 오늘의 운세 · 사주풀이 · 궁합 · 꿈해몽 · 타로' },
      description:
        '생년월일로 보는 내 사주풀이와 오늘의 운세, 두 사람의 궁합, 꿈해몽 사전, 타로 3장까지. 명리 기반 해석을 바로 확인하세요.',
      alternates: { canonical: '/' },
    };
