        ...
        <section className="space-y-5 px-1">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <div
                        className="mt-1 text-[17.8px] font-extrabold leading-snug text-[var(--app-ink)]"
                        style={{ wordBreak: 'keep-all' }}
                      >
                        {item.hook}
                      </div>
                      <div
                        className="mt-1 text-[13.2px] text-[var(--app-copy-soft)]"
                        style={{ wordBreak: 'keep-all' }}
                      >
                        {item.title}
                      </div>
          ...
          >
            ...
            <div className="mt-4 flex flex-col gap-2 sm:flex-row sm:items-center">
              <Link
                href="/membership"
                className="inline-flex items-center justify-center rounded-[12px] bg-[var(--app-pink)] px-5 py-3 text-[15.5px] font-extrabold text-white shadow-[0_12px_28px_rgba(142,42,32,0.32)]"
              >
                멤버십으로 더 깊게 열기 →
              </Link>
              <Link
