      ...
      <form id="reset-password-form" className="mt-5 space-y-4" onSubmit={submitPasswordReset}>
        ...
        <StickyBottomBar>
          <button
            ...
            className="inline-flex h-12 w-full items-center justify-center rounded-[12px] bg-[var(--app-pink)] px-5 text-[17.3px] font-extrabold text-white shadow-[0_12px_28px_rgba(142,42,32,0.32)] disabled:opacity-60"
          >
