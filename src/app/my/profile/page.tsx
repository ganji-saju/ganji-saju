    ...
    <div className="space-y-5 px-1">
      ...
      <section className="grid grid-cols-1 gap-2.5">
        <article className="rounded-[14px] border border-[var(--app-line)] bg-white p-4">
          ...
          <div className="mt-1 truncate text-[17.8px] font-extrabold tracking-tight text-[var(--app-ink)]">
            {displayName}
          </div>
          <div className="mt-1 text-[13.2px] leading-[1.55] text-[var(--app-copy-muted)]">
        ...
        <article className="rounded-[14px] border border-[var(--app-line)] bg-white p-4">
          ...
          <div className="mt-1 flex items-baseline gap-1">
            <span
              className="text-[25.3px] font-extrabold leading-none tracking-tight"
              style={{ color: 'var(--app-pink-strong)' }}
            >
              {familyCount}
            </span>
            <span className="text-[13.8px] font-bold text-[var(--app-copy-muted)]">명</span>
          </div>
          <div className="mt-1 text-[13.2px] leading-[1.55] text-[var(--app-copy-muted)]">
      ...
      >
        ...
        <div className="mt-3.5 grid grid-cols-3 gap-2">
          <Link
            href="/today-fortune"
            className="rounded-[12px] bg-white/10 px-2 py-3 text-center text-[13.8px] font-extrabold text-white"
          >
            오늘운세
          </Link>
          <Link
      ...
      <section className="rounded-[18px] border border-[var(--app-line)] bg-white p-4 sm:p-5">
        ...
        <h2 className="mt-1 text-[20.7px] font-extrabold leading-snug tracking-tight text-[var(--app-ink)]">
          정보 수정하기
        </h2>
