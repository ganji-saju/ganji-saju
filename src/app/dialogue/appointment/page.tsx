        ...
        {confirmed ? (
          <section className="space-y-5 px-1">
            ...
            <div className="grid gap-2">
              <Link
                href="/dialogue"
                className="inline-flex h-12 w-full items-center justify-center rounded-[12px] bg-[var(--app-pink)] px-5 text-[16.1px] font-extrabold text-white shadow-[0_12px_28px_rgba(142,42,32,0.32)]"
              >
                대화방으로 이동 →
              </Link>
              <Link
          ...
          <section className="space-y-5 px-1">
            ...
            <StickyBottomBar>
              ...
              <button
                ...
                className="inline-flex h-12 w-full items-center justify-center rounded-[12px] bg-[var(--app-pink)] px-5 text-[16.7px] font-extrabold text-white shadow-[0_12px_28px_rgba(142,42,32,0.32)] disabled:opacity-50"
              >
