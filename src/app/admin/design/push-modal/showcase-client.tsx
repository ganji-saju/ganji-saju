  ...
  return (
    <>
      ...
      >
        ...
        <h2
          className="mt-1 text-[16px] font-extrabold leading-[1.4] tracking-tight text-[var(--app-ink)]"
          style={{ wordBreak: 'keep-all' }}
        >
          푸시 알림 권한 모달 미리보기
        </h2>
        <p
          className="mt-1.5 text-[14px] leading-[1.65] text-[var(--app-copy-muted)]"
          style={{ wordBreak: 'keep-all' }}
        >
        ...
        {lastEvent ? (
          <div
            className="mt-3 rounded-[10px] border px-3 py-2 text-[13px] leading-[1.55]"
            style={{
