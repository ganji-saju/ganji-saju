  ...
  return (
    <div className="grid gap-4 md:grid-cols-[220px_1fr]">
        ...
        {kinds.map((k) => {
          ...
          return (
            <button
              ...
              className={
                'block w-full rounded-[10px] border px-3 py-2 text-left text-[14px] leading-[1.5] ' +
                (isSelected
      ...
      <section className="space-y-4">
        <div className="rounded-[14px] border bg-white p-4" style={{ borderColor: 'var(--app-line)' }}>
          <h2 className="text-[14px] font-extrabold">
            ...
            <a
              ...
              className="ml-2 text-[13px] font-normal text-[var(--app-copy-muted)] underline"
            >
              사용자 페이지 열기 →
            </a>
          </h2>
        ...
        >
          <h3 className="text-[14px] font-extrabold">신규 버전 생성</h3>
          ...
          <label className="block">
            ...
            <textarea
              ...
              className="mt-1 w-full rounded border px-3 py-2 text-[14px] font-mono leading-[1.6]"
              style={{ borderColor: 'var(--app-line)' }}
            />
          </label>
          ...
          <div className="grid gap-3 md:grid-cols-2">
            ...
            <label className="mt-7 flex items-center gap-2 text-[14px]">
              <input
                type="checkbox"
          ...
          <div className="flex items-center gap-3">
            <button
              type="submit"
              disabled={submitting}
              className="rounded-[10px] bg-[var(--app-pink-strong)] px-4 py-2 text-[14px] font-bold text-white disabled:opacity-50"
            >
            ...
            {message && (
              <span
                className={
                  message.type === 'ok'
                    ? 'text-[13px] text-[var(--app-jade)]'
                    : 'text-[13px] text-[var(--app-pink-strong)]'
                }
              >
                {message.text}
              </span>
        ...
        {/* 이력 */}
        <div className="rounded-[14px] border bg-white p-4" style={{ borderColor: 'var(--app-line)' }}>
          <h3 className="text-[14px] font-extrabold">버전 이력</h3>
          {history.length === 0 ? (
            <p className="mt-2 text-[13px] text-[var(--app-copy-muted)]">이력 없음.</p>
          ) : (
