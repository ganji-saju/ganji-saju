  ...
  return (
    <AdminPage title="사주 검증 도구">
        ...
        >
          ...
          <p className="mt-2 text-[14px] leading-[1.6] text-[var(--app-copy-muted)]">
        ...
        >
          ...
          <div className="mt-4 grid gap-3 sm:grid-cols-2">
            <label className="block">
              <span className="text-[13px] font-extrabold text-[var(--app-ink)]">생년월일 (YYYY-MM-DD)</span>
              <div className="mt-1 grid grid-cols-3 gap-1.5">
                <input name="year" defaultValue={params.year} placeholder="1990" type="number" min="1900" max="2100"
                  className="h-11 rounded-[10px] border bg-white px-2 text-[14px]"
            ...
            <label className="block">
              <span className="text-[13px] font-extrabold text-[var(--app-ink)]">출생시간 (HH MM, 모르면 비움)</span>
            ...
            <label className="block">
              <span className="text-[13px] font-extrabold text-[var(--app-ink)]">성별</span>
              <select name="gender" defaultValue={params.gender ?? ''}
                className="mt-1 h-11 w-full rounded-[10px] border bg-white px-2 text-[14px]"
                style={{ borderColor: 'var(--app-line)' }}>
            ...
            <label className="block">
              <span className="text-[13px] font-extrabold text-[var(--app-ink)]">자시 적용</span>
            ...
            <label className="block">
              <span className="text-[13px] font-extrabold text-[var(--app-ink)]">시간 보정 방식</span>
            ...
            <label className="block">
              <span className="text-[13px] font-extrabold text-[var(--app-ink)]">출생지 (텍스트, 선택)</span>
            ...
            <label className="block sm:col-span-2">
              <span className="text-[13px] font-extrabold text-[var(--app-ink)]">조회일 (ISO, 비우면 현재 시각)</span>
        ...
        {/* §에러 */}
        {errorMessage ? (
          <div className="rounded-[14px] border px-4 py-3 text-[14px] text-[var(--app-ink)]"
        ...
        {v1 && v2 ? (
          <>
            ...
            >
              ...
              <div className="mt-3 rounded-[12px] border bg-white p-3" style={{ borderColor: 'var(--app-line)' }}>
                <div className="text-[11px] font-extrabold uppercase tracking-[0.06em] text-[var(--app-copy-muted)]">[입력값]</div>
                <dl className="mt-1.5 grid grid-cols-[8rem_1fr] gap-y-1 text-[14px] leading-[1.7]">
              ...
              <div className="mt-3 rounded-[12px] border p-3"
                ...
                <div className="text-[11px] font-extrabold uppercase tracking-[0.06em] text-[var(--app-pink-strong)]">[계산 결과]</div>
                <dl className="mt-1.5 grid grid-cols-[8rem_1fr] gap-y-1 text-[14px] leading-[1.7]">
              ...
              <div className="mt-3 rounded-[12px] border bg-white p-3" style={{ borderColor: 'var(--app-line)' }}>
                ...
                <p className="mt-1 text-[14px] leading-[1.7] text-[var(--app-copy)]">
                ...
                {v2.verification.issues.length > 0 ? (
                  <details className="mt-2">
                    <summary className="cursor-pointer text-[13px] font-extrabold text-[var(--app-copy-muted)]">
                      검증 이슈 상세 ({v2.verification.issues.length}건)
                    </summary>
                    <ul className="mt-2 grid gap-1">
                      {v2.verification.issues.map((issue) => (
                        <li key={`${issue.code}-${issue.path}`} className="rounded-[8px] border px-2 py-1.5 text-[13px] leading-[1.55]"
                          style={{ borderColor: 'var(--app-line)' }}>
          ...
          <div className="rounded-[14px] border bg-white px-4 py-3 text-center text-[14px] text-[var(--app-copy-muted)]"
            style={{ borderColor: 'var(--app-line)' }}>
