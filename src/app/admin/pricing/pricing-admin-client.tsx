...
export function PricingAdminClient({ initialItems }: { initialItems: Item[] }) {
  ...
  const th = 'px-3 py-2 text-left text-[11.5px] font-bold text-[var(--app-copy-soft)]';
                ...
                <tr key={item.packageId} className="border-t border-[var(--app-line)]">
                  ...
                  <td className={`${td} text-right`}>
                    <button
                      ...
                      onClick={() => submit(item)}
                      className="rounded-[8px] bg-[var(--app-ink)] px-3 py-1.5 text-[13px] font-bold text-white disabled:opacity-40"
                    >
