    ...
    <section className="space-y-5 px-1">
      ...
      {state === 'loading' ? (
        ...
        >
          ...
          <p className="mt-3 text-[14px] text-[var(--app-copy-muted)]">학습 중...</p>
        </article>
      ) : state === 'error' ? (
        <article
        ...
        <>
          ...
          >
            ...
            <div className="mt-2.5 grid grid-cols-2 gap-3">
              <div>
                ...
                <div className="text-[11.5px] text-[var(--app-copy-soft)]">학습 표본</div>
              </div>
              <div>
                <div className="text-[22px] font-extrabold tabular-nums text-[var(--app-pink-strong)]">
                  {preview.preview.features.length}
                </div>
                <div className="text-[11.5px] text-[var(--app-copy-soft)]">분석 신살</div>
              </div>
              <div>
                ...
                <div className="text-[11.5px] text-[var(--app-copy-soft)]">R² (설명력)</div>
              </div>
              <div>
                <div className="text-[22px] font-extrabold tabular-nums text-[var(--app-amber)]">
                  {preview.preview.mse.toFixed(3)}
                </div>
                <div className="text-[11.5px] text-[var(--app-copy-soft)]">MSE</div>
              </div>
            </div>
            <div className="mt-2.5 text-[11.5px] text-[var(--app-copy-soft)]">
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="mt-2.5 grid grid-cols-3 items-center gap-2 text-center">
                        ...
                        <div className="text-[22px] text-[var(--app-copy-soft)]">→</div>
                        <div>
                          <div className="text-[11px] font-bold uppercase tracking-[0.06em] text-[var(--app-copy-soft)]">
                            학습
                          </div>
                      ...
                      <div
                        className="mt-2 text-[11.5px] leading-[1.5] text-[var(--app-copy-muted)]"
                        style={{ wordBreak: 'keep-all' }}
                      >
          ...
          >
            ...
            <textarea
              ...
              className="mt-2 w-full rounded-[10px] border bg-white px-3 py-2 text-[13px] leading-[1.5] text-[var(--app-ink)] focus:outline-none"
              style={{ borderColor: 'var(--app-line)' }}
              rows={2}
            />
            <button
              ...
              disabled={saving}
              className="mt-2 w-full rounded-full border px-4 py-2.5 text-[14px] font-extrabold transition-transform active:scale-95 disabled:opacity-50"
              style={{
            ...
            {savedMsg ? (
              <p className="mt-2 text-[13px] text-[var(--app-copy-muted)]">{savedMsg}</p>
            ) : null}
          </section>
        </>
      ) : (
        ...
        >
          ...
          <p className="mt-2 text-[14px] font-bold text-[var(--app-ink)]">학습 가능한 표본 부족</p>
                ...
                >
                  <div className="flex items-start justify-between gap-2">
                    <div className="min-w-0 flex-1">
                      ...
                      {isLowQuality ? (
                        <div
                          className="mt-1.5 rounded-[8px] px-2 py-1 text-[11.5px] font-bold"
                          style={{
                      ...
                      {v.note ? (
                        <div
                          className="mt-1 text-[13px] text-[var(--app-copy-muted)]"
                          style={{ wordBreak: 'keep-all' }}
                        >
                          {v.note}
                        </div>
                  ...
                  {!isActive ? (
                    <button
                      ...
                      className="mt-2.5 w-full rounded-full border px-3 py-1.5 text-[13px] font-bold transition-transform active:scale-95"
                      style={{
                        background: 'white',
                        color: 'var(--app-jade)',
