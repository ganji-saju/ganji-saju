    ...
    items: [
      {
        ...
        a: '결제 후 30초 안에 자동 충전됩니다. 새로 고침 후에도 반영되지 않으면 결제 영수증을 들고 1:1 문의로 알려주세요. 카드 결제는 보통 즉시, 계좌이체는 영업일 1일 이내에 처리됩니다.',
      },
      {
        q: '오늘 자세히 보기·캘린더는 얼마인가요?',
        a: '오늘 자세히 보기, 좋은날 1개월 캘린더 모두 직접 결제 시 9,900원입니다. 보유한 코인으로도 열 수 있으며 콘텐츠별 코인 차감량은 결제 화면에서 안내됩니다. 코인은 결제 시점부터 1년간 유효합니다.',
      },
      {
    ...
    items: [
      {
        ...
        a: '프리미엄 (49,000원/월, 30일 이용권): 매월 90코인 지급, 매일 대화 5건 무료, 궁합 월 3회 무료, 가족 사주 5명 등록. 공정사용정책이 적용됩니다.',
      },
      {
