...
const FAQ_GROUPS: FaqGroup[] = [
    ...
    items: [
      {
        ...
        a: '라이트 (4,900원/월): 매일 해석 10회, 사주풀이 미리보기 월 2회. 프리미엄 (9,900원/월): 모든 해석 무제한 + 궁합 월 3회 + 가족 5명 + 대화 상담 무제한.',
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: '네, 같은 날짜는 동일한 점수가 보이도록 시드 고정. 매일 자정 (KST 0시) 기준으로 새로운 일진 풀이로 바뀝니다.',
      },
      {
  ...
  },
  {
    ...
    items: [
      {
        q: '비밀번호를 잊었어요',
        a: '로그인 화면의 "비밀번호 찾기" 링크를 통해 이메일로 재설정 링크를 받을 수 있습니다.',
      },
      {
        q: '회원탈퇴는 어떻게 하나요?',
      ...
      },
      {
        ...
        a: '네, 가족·다른 사람 정보로 5명까지 저장 가능합니다 (프리미엄 멤버십 기준). /my/profile 에서 관리할 수 있습니다.',
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        q: '검색 기능은 언제 추가되나요?',
        a: '준비 중입니다. 사주 결과·꿈해몽·고전 등을 통합 검색하는 기능이 곧 추가될 예정입니다.',
      },
      {
        q: '아래에 없는 질문이 있어요',
