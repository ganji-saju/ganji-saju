    ...
    <AppShell header={<SiteHeader />} className="gangi-subpage-shell pb-24 md:pb-12">
      <AppPage className="gangi-subpage saju-result-page space-y-5">
        <section className="space-y-5 px-1">
          ...
          <Link
            href="/today-fortune"
            className="inline-flex w-full items-center justify-center rounded-[12px] bg-[var(--app-pink)] px-4 py-3 text-[15px] font-extrabold text-white shadow-[0_12px_28px_rgba(142,42,32,0.32)]"
          >
            내 오늘운세 보러가기 →
          </Link>
