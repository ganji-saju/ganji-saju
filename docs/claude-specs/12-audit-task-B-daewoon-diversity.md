...
// naming-policy.md §12 정규식 + 04-spec 자극 표현
const forbiddenPatterns: Array<[RegExp, string]> = [
  [/대박|암흑기|텅장|꿀팁|비책/g, '자극 표현'],
...
**A. ✅ 충족** — 04-spec 기준 모두 통과. 다양성 보강 작업 *불필요*.
...
> **9개 대운 풀이가 *실제로* 얼마나 다양한지를 4축(본문 유사도·제목 고유성·금지 표현·길이)으로 정량 측정. 결과 보고만, 보강은 별도 단계. read-only 원칙.**
