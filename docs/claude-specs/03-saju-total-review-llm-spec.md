...
- ⭕ "조용히 살피고 흐르는 사주, **작은 원칙 하나가 평생을 받쳐줍니다**"
...
```json
{
  ...
  "wonkuk": {
    ...
    "kyeokguk_easy": {
      "label": "말하고 살피는 별이 명확한 사주",
      "detail": "본인 안의 것을 부드럽게 말하고 주변을 챙기는 패턴이 평생 따라옴",
...
[좋은 예]
- "조용히 살피고 흐르는 사주, 작은 원칙 하나가 평생을 받쳐줍니다"
- "관찰력 강한 결, 거절선만 잡으면 흐름이 안정됩니다"
- "타고난 전달력 위에, 작은 마무리 습관 하나가 평생을 바꿉니다"
...
- 단락 간 *동일 문장 절대 금지* — 만약 같은 데이터를 재참조하면 문장을 다르게
...
- 본문: 1~2문장. key_weaknesses_easy에서 가장 큰 약점 + *구체 행동* 1개
  (예: "'아니오'를 못하면 에너지가 빠르게 새요. 거절선 1~2개를 외부에 적어두세요")
...
```json
{
  "one_line_summary": "조용히 살피고 흐르는 사주, 작은 원칙 하나가 평생을 받쳐줍니다",

  "main_narrative": {
    "paragraph_1_who_you_are": "테스트 님의 타고난 성향은 물처럼 부드럽게 흐르는 편이에요. 강하게 밀어붙이기보다 주변을 먼저 살피고, 필요한 곳에 자연스럽게 자기를 맞추는 사주입니다. 사람들 사이에서는 '편안한 사람', '오래 같이 있고 싶은 사람'이라는 인상을 줄 거예요.\n\n다만 사주의 자기 축이 다소 약한 편이라, 너무 많은 일이나 사람에 둘러싸이면 본인의 페이스를 잃기 쉽습니다. 말하고 살피는 기운은 잘 살아 있는데, 결단하고 마무리하는 쪽이 보강을 필요로 합니다.",
  ...
  "lifetime_keys": [
    ...
    },
    {
      "title": "단호함과 마무리",
      "subtitle": "거절선이 평생 자산",
      "body": "'아니오'를 못하면 에너지가 빠르게 새요. 받아들이지 않을 일의 거절선 1~2개를 외부에 적어두면 평생 도움이 됩니다."
    },
    {
      "title": "금 기운 들이기",
...
function validateTotalReview(output: TotalReviewOutput, context: {
  ...
  const forbiddenPatterns: Array<[RegExp, string]> = [
    ...
    [/(표현|생각|절제|직관|돌봄|관찰|베푸는)의\s*기운/g, '십성 추상명사화 (예: 말의 기운)'],
  ...
  for (const word of clickbait) {
    if (fullText.includes(word)) reasons.push(`자극적/단정 문구: ${word}`);
  }
