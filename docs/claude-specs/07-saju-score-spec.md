...
낮은 점수를 받은 사람이 *오히려 흥미를 느끼고* 더 깊게 보고 싶어 하도록 표현해야 합니다.
...
- 약점은 *보강 가능성*으로 표현 ("금 기운과 화 기운을 의식적으로 들이면 큰 변화")
