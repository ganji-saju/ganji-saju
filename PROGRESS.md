...
- ⚠️ **`bundle_today_set` 19,800원 미해결** — 구성품 today-detail 이 3,300원이 되며 묶음이
  비합리해졌다. `premium-lock-card` 가 단품 vs 묶음을 나란히 노출해 사용자가 즉시 계산한다.
